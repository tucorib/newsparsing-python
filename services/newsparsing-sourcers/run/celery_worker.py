...
if __name__ == '__main__':
    # Arguments
    parser = argparse.ArgumentParser(description='Launch newsparsing-sourcers celery worker.')
    ...
    parser.add_argument('-c',
                        ...
                        default=os.path.join(os.path.dirname(__file__), "../conf/celery.conf"),
                        help='newsparsing-sourcers celery configuration file path')
